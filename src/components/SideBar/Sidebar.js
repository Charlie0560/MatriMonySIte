                ...
                {messageDown && (
                    <div className="messages-content">
                        {messages.map((message, index) => (
                            <div key={index} className="userChat" onClick={() => handleSelectSender(message)}>
                                <img className='profile-image-chat' src={require(`../../images/${message.profilePic}`)} alt="" />
                                <div className="userChatInfo">
                                    <span>{message.name}</span><br />
                                    {message.latestMessage ? <span id='latest-message'>{message.latestMessage}</span> : null}
                                </div>
                            </div>
                        ))}
                    </div>
                ...
                {interestsDown && (
                    <div className="interests-content">
                        {yourInterests.map((interest, index) => (
                            <div key={index} className="userChat" onClick={() => handleSelectSender(interest)}>
                                <img className='profile-image-chat' src={require(`../../images/${interest.profilePic}`)} alt="" />
                                <div className="userChatInfo">
