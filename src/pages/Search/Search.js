        ...
        <div className='search-main'>
              <div className='search-container'>
                  ...
                  <div className='search-form'>
                      <input className='searchIput' type='text' placeholder='Native Place' />
                      <input className='searchIput' type='text' placeholder='Profession' />
                      <input className='searchIput' type='number' placeholder='Age above' />
                      <input className='searchIput' type='number' placeholder='Age below' />
              ...
              <div className='profiles'>
                  {response.map((profile, index) => (
                      <div className="profile" key={index}>
                          <img className="user-image" src={require(`../../images/${profile.profilePic}`)} alt={`User ${index}`} />
                          <div className="info-wrapper">
                              <div className="info">
                                  <div className="Name">
                                      <span className='title'>Name : </span>
                                      <span id={`name-span-${index}`}>
                                          {`${profile["First Name"]} ${profile["Middle Name"]} ${profile["Last Name"]}`}
                                      </span>
                                  </div>
                                  <div className="age-user">
                                      <span className='title'>Birth Date : </span>
                                      <span id={`birth-date-span-${index}`}>{`${profile.Date} ${profile.Month} ${profile.Year}`}</span>
                                  </div>
                                  <div className="native-place">
                                      <span className='title'>Native Place : </span>
                                      <span id={`native-place-span-${index}`}>{profile["Native Place"]}</span>
                                  </div>
                                  <div className="profession">
                                      <span className='title'>Profession : </span>
                                      <span id={`profession-span-${index}`}>{profile.Profession}</span>
                                  </div>
                              ...
                              <div className="visit-btn">
                                  <button onClick={() => handleVisitProfile(profile)}>Visit Profile</button>
                              </div>
                          </div>
                      </div>
                  ))}
